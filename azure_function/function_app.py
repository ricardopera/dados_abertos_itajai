...
@app.route(route="http_trigger_Dados_Aberto_Matricula_Meses")
def http_trigger_Dados_Aberto_Matricula_Meses(req: func.HttpRequest) -> func.HttpResponse:
...
@app.route(route="gerar_relatorio_matricula")
def gerar_relatorio_matricula(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Processando requisição para gerar relatório de matrícula.')
